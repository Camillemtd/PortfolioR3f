    ...
    .map((_, index) => {
      ...
      return (
        <group key={index}>
          ...
          {selectedPlane === index && (
            <Html fullscreen>
              <div className="flex xl:w-1/2 w-full  text-white w-100 justify-between pt-32 pl-10 slide-in-right ">
                <div className="w-1/2 flex flex-col">
                  ...
                  <div className="w-100 flex justify-center mb-2 p-10 gap-10">
                    {data[index % data.length].lienGit ? (
                      <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href={data[index % data.length].lienGit}
                      >
                        <svg
