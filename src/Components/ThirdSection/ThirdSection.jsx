...
const ThirdSection = () => {
  return (
    <section className="bg-black bg-opacity-50 z-40 slide-in-bottom text-white p-10 md:m-20  h-full max-h-full min-h-screen h-full flex justify-center flex-col items-center max-w-screen-xl self-center">
        <h2 id="skill" className="text-focus-in xl:text-9xl text-6xl font-medium text-center mb-20 mt-20 xl:mt-0">SKILLS</h2>
        ...
        <h2 className="text-6xl text-center mb-20 mt-20 xl:mt-48">Contact</h2>
        <Contact/>
    </section>
  );
};
